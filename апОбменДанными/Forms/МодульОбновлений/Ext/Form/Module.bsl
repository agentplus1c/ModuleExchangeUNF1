...
Процедура ИнициализироватьДанныеВХранилищеДляНовойВерсии()
	...
	Если ЭтоПервыйЗапуск Тогда // первый запуск
		...
		//vd_180223 СтатусЗаказов нигде не используется удалим этот параметр 
		//стррЗначения.Вставить("СтатусЗаказов", Перечисления.СтатусыЗаказов.ВРаботе); //Неуверен что правильно
