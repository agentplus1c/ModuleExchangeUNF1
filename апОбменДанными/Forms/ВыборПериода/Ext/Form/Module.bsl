...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.Свойство("ДатаНачала") Или Не Параметры.Свойство("ДатаОкончания") Тогда
		ВызватьИсключение(СтрШаблон_(НСтр("ru = 'Форма ""%1"" - не получены все параметры: ДатаНачала, ДатаОкончания.'; uk = 'Форма ""%1"" - не отримані всі параметри: ДатаНачала, ДатаОкончания.'"),
										ЭтаФорма.Заголовок));
	КонецЕсли; 
...
Процедура КомандаОК(Команда)
	...
	Если ДатаОкончания < ДатаНачала Тогда
		ПоказатьПредупреждение(Неопределено, НСтр("ru='Период указан неверно';uk='Період вказано невірно'"));
	Иначе
